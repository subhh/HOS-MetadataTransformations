...
# config
codename="ukefdm" # used for filename, name of OpenRefine project and value for Solr field "collectionId"
oai_url="https://www.fdr.uni-hamburg.de/oai2d" # base url of OAI-PMH endpoint
oai_set="user-uke" # optional: OAI-PMH set spec (e.g. institution)
