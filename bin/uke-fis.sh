...
### !!! the oai endpoint of fis-uke.de is behind a firewall; remove the following exit command to include the script in the workflow !!! ###
exit
...
# config
codename="uke-fis" # used for filename, name of OpenRefine project and value for Solr field "collectionId"
